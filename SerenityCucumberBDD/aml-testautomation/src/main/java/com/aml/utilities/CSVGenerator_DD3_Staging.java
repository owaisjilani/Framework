...
public class CSVGenerator_DD3_Staging{
	    ...
	    private static List<String> uscities = asList("Montgomery", "Juneau","Phoenix","Connecticut"); 
	    private static List<String> usstates = asList("Alabama", "Alaska","Arizona","Hartford"); 
