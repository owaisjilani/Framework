...
public class CSVGenerator_Sanctions{
	    ...
	    private static List<String> identificationDocumentType = asList("PASSPORT", "DRIVING LICENSE");
	    private static List<String> phoneType = asList("HOME", "WORK");
	    private static List<String> transactionOperation = asList("CREDIT", "DEBIT"); 
	    private static List<String> individualOFACFirstname = asList("Sherbaz","Mali","Hafiz Saeed","Shahbaz","Bahawal","Mustafa Hajji Muhammad","Abdul Qadeer","Mohammad Naushad Alam","Nasir Ali","Dilawar Khan Nadir"); 
	    private static List<String> businessOFACName = asList("LOYALIST VOLUNTEER FORCE","ORANGE VOLUNTEERS","RED HAND DEFENDERS","ULSTER DEFENCE ASSOCIATION","REVIVAL OF ISLAMIC HERITAGE SOCIETY",""); 
		...
		static private void createIndividualCSV(int noOfRecords,int individualStartRange) {
	        ...
	        .column("")
	        .column(fromStrings(individualOFACFirstname))
	        .column("")
	        .column("KHAN")
	        .column("")
	        .column("")
		...
		static private void createBusinessCSV(int noOfRecords,int businessStartRange) {
		        ...
		        csvs()
		            ...
		            .column("2000-10-17 12:31:26")
		            .column("")
		            .column(fromStrings(businessOFACName))
		            .column("")
		            .column("NAICS")
